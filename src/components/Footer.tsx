  ...
  return (
    <footer className="bg-secondary p-12">
      ...
      <div className="flex justify-between items-center text-white">
        <ul itemType="none" className="flex gap-6">
          <li>
            <Link
              to="https://instagram.com/rescentify"
              target="_blank"
              className="fill-white hover:fill-primary transition-colors"
            >
              <svg
                role="img"
                height="24"
          ...
          <li>
            <Link
              to="https://tiktok.com/@rescentify"
              target="_blank"
              className="fill-white hover:fill-primary transition-colors"
            >
              <svg
